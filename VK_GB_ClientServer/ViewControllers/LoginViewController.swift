...
class LoginViewController: UIViewController {
    ...
    @IBAction func loginButtonPressed(_ sender: Any) {
        performCirclesAnimation() {
            self.perform(#selector(self.login),
    ...
    private func performCirclesAnimation(_ completion: @escaping ()->()) {
        ...
        animateCircle(object: circle1, delay: 0)
        animateCircle(object: circle2, delay: 0.33)
        animateCircle(object: circle3, delay: 0.66)
        ...
        func animateCircle(object: CALayer, delay: CGFloat) {
            ...
            object.add(animation, forKey: nil)
        }
